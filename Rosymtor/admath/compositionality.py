...
import admath.utils_com as utils
...
def cli_main():
    ...
    all_out = []
    out = expr_simple_comp_addcoeff(generations, env, encoder, decoder, args.top_n, device, n=1)
    utils.save(out, args.output_dir, 'simple_comp_addcoeff')
    all_out.extend(out)

    out = expr_simple_comp_addexp(generations, env, encoder, decoder, args.top_n, device, n=1)
